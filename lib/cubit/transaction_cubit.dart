...
class TransactionCubit extends Cubit<TransactionState> {
  ...
  Future<void> changeStatusTransaction(
      Transaction transaction) async {
    ApiReturnValue<Transaction> result =
        await TransactionServices.changeStatusTransaction(transaction);

    (state as TransactionLoaded).transactions.removeWhere((oldTransaction) => oldTransaction.id == transaction.id);
